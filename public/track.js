...
async function generateStory(track, user) {
    ...
    el o la protagonista debe de llamarse ${user.name}, en lo posible el protagonista debe de tener como maximo 25 años, el capitulo debe de ser de 5 párrafos grandes por lo menos 6000 caracteres`;
